...
export default function CreateTournamentPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      minPlayer: formData.minPlayers,
      maxPlayer: formData.maxPlayers,
      description: formData.rules,
      location: formData.location,
      categories: formData.categories,
      entryFee: parseFloat(formData.entryFee) || 0,
      prizePool: parseFloat(formData.prizePool) || 0,
      registrationDeadline: formData.registrationEnd ? new Date(formData.registrationEnd).toISOString() : null,
      startDate: formData.tournamentStart ? new Date(formData.tournamentStart).toISOString() : null,
      endDate: formData.tournamentEnd ? new Date(formData.tournamentEnd).toISOString() : null,
      createBy: 1, // TODO: Get from logged-in user
      notes: ''
    };
          ...
          >
            ...
            <div className="tlc-field-half">
              ...
              <input
                ...
                onChange={handleInputChange}
                placeholder="e.g., Hanoi Chess Club"
              />
            </div>
